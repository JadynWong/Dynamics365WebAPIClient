...
namespace D365WebApiClient.WebApiQueryOptions.Options.Filter
{
    ...
    public sealed class ConditionExpression
    {
        ...
        public ConditionExpression(string attributeName, ConditionOperator conditionOperator, short value)
        {
        ...
        public override string ToString()
        {
            ...
            else
            {
                ...
                if (valueType == typeof(string))
                {
                    value = string.IsNullOrWhiteSpace(Value as string) ? "''" : $"'{Value}'";
                         ...
                         valueType == typeof(long) || valueType == typeof(short))
                {
                    value = $"{Value}";
                }
            ...
            switch (this.Operator)
            {
                ...
                default:
                    throw new ArgumentException($"UnSupport Operation,{this.Operator}", $"Operator");
            }
        }
    }
}